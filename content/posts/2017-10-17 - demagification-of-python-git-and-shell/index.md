---
title: "Demagification of Python, Git and Shell"
...
With increasing number of data sources and digital tools playing a key role in today’s scholarly research, mastering the essential skills to efficiently deal with such data and tools becomes indispensible for academic researchers. To run our [research projects](https://www.esciencecenter.nl/projects) at the eScience Center in an efficient way, it is important that also our collaborators at universities develop the right digital skills. These skills include

For this purpose we organized three workshops for our project members based on the [Software](https://software-carpentry.org/) and [Data Carpentry](http://www.datacarpentry.org/) model. The workshops focused on Version Control with Git & GitHub, Scientific data analysis with Python and Unix Shell & Task Automation.
...
![](./1_RxEy7Gvsc3CVfhQuMAFnkQ-cc0df229.jpeg)
...
![](./1_9RMXrTRWLqKKsDXsw8zmCw-78b7b330.jpeg)
...
![](./1_wt6Hj-laynLpbqVuoMdpvw-46f7b3a1.jpeg)
...
Want to learn essential skills for digital science as well? Stay up to date! [Sign up for our newsletter](http://eepurl.com/Szzyf) in which we will announce future workshops.
