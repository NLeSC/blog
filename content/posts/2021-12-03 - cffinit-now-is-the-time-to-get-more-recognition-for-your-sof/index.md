...
![Image of cinema with many people watching a screen. Instead of a film, the screen shows the recognition image from Scriberia.](./0_VMyjOtrq1IOnHncO-1e5ef4de.webp)
...
![Recognition image from Scriberia. A banner with Recognition written on it appears above software developers and researchers standing on pillars. Software citation helps developers pillar to go to higher level, represented by an arrow.](./0_SCmONGUG4gHQkhqA-42229c69.webp)
...
![A cat looks at a computer screen where the landing page of cffinit is shown.](./0_J2ZZyZSLxMFGZQGR-0312c8a3.webp)
...
![GitHub repository with “Cite this repository” button clicked and popup showing the formatted citation information.](./0_Mt6W7VkzjkCLICvz-118ee885.webp)
