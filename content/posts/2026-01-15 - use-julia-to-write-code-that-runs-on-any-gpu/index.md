...
![Use Julia to write code that runs on any GPU](./use-julia-to-write-code-that-runs-on-any-f2817526.jpg)
...
![Use Julia to write code that runs on any GPU](./use-julia-to-write-code-that-runs-on-any-6be9197d.gif)
