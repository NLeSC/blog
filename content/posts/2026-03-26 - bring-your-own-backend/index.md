...
![Bring Your Own Backend](./bring-your-own-backend-58215f84.png)
...
![Bring Your Own Backend](./bring-your-own-backend-f8659c4d.png)
...
![Bring Your Own Backend](./bring-your-own-backend-eb41ae53.png)
When the frontend is unable to connect to the specified backend, it shows an error message with troubleshooting tips:

![Bring Your Own Backend](./bring-your-own-backend-cdf89285.png)
